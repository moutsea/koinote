...
func TestDesktopAuthorizationValidation(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{http.MethodGet, "/api/media/settings", true},
		{http.MethodPut, "/api/media/settings", true},
		{http.MethodGet, "/api/media/custom-platforms", false},
		{http.MethodPost, "/api/media/custom-platforms", true},
		{http.MethodPut, "/api/media/custom-platforms/platform-id", true},
		{http.MethodDelete, "/api/media/custom-platforms/platform-id", true},
		...
		{http.MethodPost, "/api/feedback", true},
		{http.MethodGet, "/api/feedback", false},
		...
		{http.MethodGet, "/api/documents/doc-id/wechat-geo-summary", true},
		{http.MethodPut, "/api/documents/doc-id/wechat-geo-summary", true},
		{http.MethodPost, "/api/documents/doc-id/wechat-geo-summary/generate", true},
		{http.MethodDelete, "/api/documents/doc-id/wechat-geo-summary", false},
		{http.MethodPost, "/api/documents/doc-id/wechat-draft", true},
		{http.MethodGet, "/api/documents/doc-id/wechat-draft", false},
		{http.MethodGet, "/api/wechat/account", true},
		{http.MethodPut, "/api/wechat/account", true},
		{http.MethodDelete, "/api/wechat/account", true},
		{http.MethodPost, "/api/wechat/account", false},
		{http.MethodGet, "/api/zhihu/account", true},
		{http.MethodPut, "/api/zhihu/account", true},
		{http.MethodDelete, "/api/zhihu/account", true},
		{http.MethodPost, "/api/zhihu/account", false},
		{http.MethodPost, "/api/documents/doc-id/x/publish", true},
		{http.MethodGet, "/api/documents/doc-id/x/publish", false},
		{http.MethodPost, "/api/documents/doc-id/media/platform-id/publish", true},
		{http.MethodGet, "/api/documents/doc-id/media/platform-id/publish", false},
		{http.MethodGet, "/api/x/account", true},
		{http.MethodPut, "/api/x/account", true},
		{http.MethodDelete, "/api/x/account", true},
		{http.MethodPost, "/api/x/account", false},
		{http.MethodGet, "/api/x/oauth2/start", true},
		{http.MethodPost, "/api/x/oauth2/start", false},
		{http.MethodDelete, "/api/x/oauth2/account", true},
		{http.MethodGet, "/api/x/oauth2/account", false},
		{http.MethodGet, "/api/feishu/oauth/start", true},
		{http.MethodPost, "/api/feishu/oauth/start", false},
		{http.MethodGet, "/api/feishu/account", true},
		{http.MethodDelete, "/api/feishu/account", true},
		{http.MethodPost, "/api/feishu/account", false},
		{http.MethodPost, "/api/documents/doc-id/feishu-sync", true},
		{http.MethodGet, "/api/documents/doc-id/feishu-sync", false},
		{http.MethodGet, "/api/wechat/accounts", true},
		{http.MethodPost, "/api/wechat/accounts", true},
		{http.MethodPut, "/api/wechat/accounts/account-id", true},
		{http.MethodDelete, "/api/wechat/accounts/account-id", true},
		{http.MethodPut, "/api/wechat/accounts/account-id/default", true},
		{http.MethodPost, "/api/wechat/accounts/account-id/default", false},
		{http.MethodPost, "/api/wechat/cover/generate", true},
		{http.MethodGet, "/api/wechat/cover/generate", false},
		{http.MethodPost, "/api/documents/doc-id/zhihu/publish", true},
		{http.MethodGet, "/api/documents/doc-id/zhihu/publish", false},
		...
		{http.MethodGet, "/api/admin/feedback", true},
		{http.MethodPost, "/api/admin/feedback", false},
