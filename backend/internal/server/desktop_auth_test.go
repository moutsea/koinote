...
func TestDesktopAuthorizationValidation(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{http.MethodGet, "/api/agent/workspace", true},
		{http.MethodPut, "/api/agent/workspace", true},
		{http.MethodPatch, "/api/agent/workspace", true},
		...
		{http.MethodPut, "/api/agent/workspaces/1", true},
		{http.MethodPatch, "/api/agent/workspaces/1", true},
		{http.MethodPut, "/api/agent/workspaces/1/metadata", true},
		{http.MethodDelete, "/api/agent/workspaces/1", true},
		{http.MethodGet, "/api/agent/workspace/prompt", true},
		{http.MethodGet, "/api/agent/workspace/files/file-id", true},
		{http.MethodPut, "/api/agent/workspace/files/file-id", false},
