...
export const en: Messages = {
  ...
  agentWorkspace: {
    title: "Skills/Agent cloud sync",
    repositoryHubTitle: "Skills/Agent Hub",
    repositoryHubDescription: "Manage your Skills, system prompts, and Agent configuration repositories in one place, then open each repository to work with its contents.",
    settingsTitle: "Skills/Agent settings",
    settingsDescription: "Enable cloud sync and manage the dedicated tokens that your Agents use to access your repositories.",
    repositoriesTab: "Repositories",
    settingsTab: "Settings",
    newRepository: "New repository",
    searchRepositories: "Search repositories",
    searchRepositoriesPlaceholder: "Find a repository…",
    repositoryCount: "{count} repositories",
    noSearchResults: "No repositories match your search.",
    workspaceAbout: "Your workspace",
    privateWorkspaceDescription: "Private Skills and Agent configuration repositories available only to you and authorized Agents.",
    openSettings: "Open sync settings",
    description: "Securely sync Skills, system prompts, and portable settings with Koinote so they remain available on another device. Check for sensitive data before uploading.",
    membersOnly: "Skills/Agent cloud sync is available to lifetime members.",
    tokenTitle: "Step 2: Create an access token",
    tokenSettingsTitle: "Agent access tokens",
    tokenDescription: "Create a dedicated Agent credential that works with both the REST API and MCP. You can revoke or update it at any time.",
    apiTitle: "REST API configuration",
    apiDescription: "Use the same Agent token to read or synchronize Skills/Agent repositories over HTTP.",
    apiExample: "REST API example",
    mcpTitle: "MCP configuration",
    mcpDescription: "Use the same Agent token to connect compatible Agents through Streamable HTTP MCP.",
    enableStep: "Step 1: Enable Skills/Agent cloud sync",
    enable: "Enable cloud sync",
    enabled: "Enabled",
    enableFailed: "Could not enable sync. Please try again.",
    repositoriesTitle: "Step 3: Manage Skills/Agent repositories",
    repositoriesDescription: "Each repository stores one set of Skills, system prompts, and Agent settings. Agents can read it through API or MCP.",
    noRepositories: "No repositories yet. Create your first repository, then import its Agent settings.",
    createFirst: "Create your first repository",
    createRepository: "Create repository",
    createRepositoryTitle: "Create a new repository",
    createRepositoryDescription: "Set up a private home for one set of Skills, system prompts, and Agent settings.",
    createRepositoryNameHint: "Choose a clear name that helps you recognize this configuration later.",
    createRepositoryVisibility: "Private repository",
    createRepositoryVisibilityDescription: "Only you and Agents authorized with your Agent token can access this repository.",
    repositoryName: "Repository name",
    repositoryDescription: "Repository note",
    repositoryNamePlaceholder: "For example: Writing Agent",
    repositoryDescriptionPlaceholder: "Optional, to distinguish configurations",
    createFailed: "Could not create the repository. Check the name and try again.",
    selectRepository: "Select repository",
    editRepository: "Edit repository",
    saveRepository: "Save repository details",
    repositorySettings: "Repository settings",
    repositorySettingsSaveFailed: "Could not save repository settings. Please try again.",
    deleteRepository: "Delete repository",
    deleteRepositoryConfirm: "All files in this repository will be permanently deleted. Continue?",
    repositorySaved: "Repository details saved.",
    repositoryDeleted: "Repository deleted.",
    repositoryLoadFailed: "Could not load repositories. Please try again.",
    localMode: "Local mode never connects to the cloud, so the Agent settings workspace is unavailable.",
    loading: "Loading workspace…",
    loadFailed: "Could not load the workspace. Please try again.",
    fileCount: "{count} files",
    revision: "Revision",
    empty: "No hosted settings yet",
    chooseFiles: "Choose Agent settings files",
    importButton: "Import Agent settings",
    selected: "{count} files selected; saving replaces the current hosted workspace.",
    limits: "Web imports replace the hosted workspace: 5 MiB per file, with no fixed total-size limit. For incremental Agent sync, use PATCH or MCP upsert/delete. Redact API keys, tokens, passwords, and private keys first.",
    upload: "Upload and sync",
    saved: "Hosted settings updated.",
    saveFailed: "Could not save hosted settings. Check the files and try again.",
    copyPrompt: "Copy for AI Agent",
    copied: "Copied",
    promptHint: "Copying includes the current Agent token in the prompt. Treat the full content as sensitive; only paste it into an AI Agent you trust, and never publish or commit it.",
    promptFailed: "Could not generate the Agent sync credential. Please try again.",
    backToRepositories: "Back to repositories",
    filesTitle: "Repository files",
    privateBadge: "Private",
    kindBadge: "Skills / Agent",
    overviewTitle: "Repository overview",
    updatedLabel: "Last updated",
    refresh: "Refresh",
    importTitle: "Import configuration files",
    importDescription: "Choose files or drop them here. Importing automatically replaces the current repository contents.",
    dropFiles: "Drop files here, or click to choose files",
    securityTitle: "Security reminder",
    securityDescription: "Redact API keys, tokens, passwords, cookies, private keys, and other credentials before uploading. Koinote never executes repository scripts or installs dependencies.",
    hashLabel: "SHA-256",
    overviewTab: "Overview",
    filesTab: "Files",
    aboutTitle: "About",
    repositoryId: "Repository ID",
    syncTitle: "Sync with your Agent",
    syncDescription: "Use the generated prompt to let your trusted Agent read or update this repository through the REST API or MCP.",
    uploadFiles: "Import files",
    importFolder: "Import folder",
    readmeDescription: "How to connect, upload, sync, and stay safe",
    readmeImportHint: "Importing a folder replaces hosted files. README.md is preserved unless the folder includes its own README.md.",
    readmeMissing: "This repository has no README.md. Import a folder to add Skills, system prompts, and Agent settings.",
    readmeLoadFailed: "README.md could not be loaded. You can still import a folder below.",
    emptyDescription: "Import Skills, system prompts, or Agent settings to start using this repository.",
  },
  llmChannels: {
  ...
  mcp: {
    ...
    agentRead: "Agent API/MCP read only",
    agentWrite: "Agent API/MCP read and write",
    expiry: "Expires in",
    days: "{n} days",
  ...
  editor: {
    ...
    mediaExportHint: "Optimized for WeChat, Zhihu, Juejin, and X",
    ...
    wechatCoverPersistenceFailed:
      "The cover was generated, but could not be saved for later use.",
    ...
    wechatCoverReferenceUploadFailed:
      "Could not upload the reference image. Try again later",
    wechatTitleLimit:
