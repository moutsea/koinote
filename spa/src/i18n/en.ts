...
export const en: Messages = {
  ...
  wechatGuide: {
    ...
    billingBody:
      "Binding an account does not use credits; each successful draft sync costs 20 credits, and failed syncs are not charged. Binding and draft delivery are available to paid members. An AI cover costs an additional 20 credits when generation succeeds; failed generations do not charge. Cover generation also requires Lifetime membership, available credits, and an image model configured for the service.",
  ...
  docsCenter: {
    ...
    quickStartSteps: [
      ...
      },
      {
        ...
        desc: "Create a read-only link, export Markdown, HTML, Word, or PDF, or prepare content for WeChat, Zhihu, and X.",
      },
    ],
    ...
    workflows: [
      ...
      },
      {
        ...
        items: [
          ...
          "Export for WeChat Official Accounts, Zhihu, and X",
        ],
      },
      {
        title: "Desktop app",
  ...
  feishu: {
    ...
    accountHint: "Documents are saved to your Feishu space. Authorization tokens are encrypted on the server.",
    openPlatform: "Feishu Open Platform",
    bind: "Connect Feishu",
    unbind: "Disconnect",
    unbindConfirm: "Disconnect Feishu? Existing Feishu documents will be kept.",
    notBound: "Connect your Feishu account in Settings first.",
    unavailable: "The server has not configured a Feishu app. Contact your administrator.",
    connected: "Feishu account connected.",
    loading: "Loading Feishu account…",
    retry: "Retry",
    failed: "Feishu operation failed. Check authorization, document permissions or your connection and retry.",
    sync: "Sync to Feishu",
    syncing: "Syncing to Feishu…",
    syncHint: "Creates a document the first time, then updates the same document. Each sync replaces its title and content with Koinote's, including edits made in Feishu.",
    formats: "Supports common Markdown, tables and images. Formulas, custom modules and themes may retain source text or simplified formatting.",
    created: "Feishu document created.",
    updated: "Feishu document updated.",
    open: "Open Feishu document",
    close: "Close",
    saveFailed: "Finish saving and syncing the document and images before retrying.",
    tokenInvalid: "Feishu authorization expired. Reconnect your account.",
    busy: "Another Feishu operation is running. Try again shortly.",
    serverBusy: "The Feishu service is busy. Try again shortly.",
    contentLimit: "Sync supports up to 5,000 blocks, 20 images and 1,000 blocks per nested structure.",
    imageFailed: "An image could not be read or its format is unsupported. Check your images and retry.",
    permissionDenied: "Feishu denied access. Check app permissions and document editing access.",
  },
  settingsPage: {
    media: "Publishing",
    mediaDescription: "Manage account connections and publishing settings for WeChat, Zhihu, and X.",
    title: "Settings",
    subtitle:
    ...
    mediaPlatformsTitle: "Publishing platform switches",
    mediaPlatformsDescription:
      "Turn a platform off to remove it from document publishing. When all are off, the publishing entry disappears from the export menu.",
    mediaSettingsLoading: "Loading publishing settings…",
    mediaSettingsLoadFailed: "Could not load publishing settings. Try again.",
    mediaSettingsSaveFailed: "Could not save the platform switch. Try again.",
    mediaEnabled: "Enabled",
    mediaDisabled: "Disabled",
    customMediaTitle: "Custom API platforms",
    customMediaDescription:
      "Configure an HTTPS API so Koinote can send articles to your own system or another platform using one stable request format.",
    customMediaAdd: "Add platform",
    customMediaEmpty: "No custom platforms yet.",
    customMediaFormatTitle: "Request format",
    customMediaFormatDescription:
      "The endpoint receives POST JSON. Any 2xx response is treated as success; an optional url field is returned as the article link. If configured, the token is sent as Authorization: Bearer.",
    customMediaName: "Platform name",
    customMediaEndpoint: "API endpoint",
    customMediaEndpointHint:
      "Must be a public HTTPS URL. Your system defines the path and handles the request.",
    customMediaAuthToken: "Bearer token",
    customMediaAuthTokenHint:
      "Optional. The token is encrypted and never shown; leave it blank while editing to keep the existing token.",
    customMediaClearToken: "Remove the saved token",
    customMediaEdit: "Edit platform",
    customMediaDelete: "Delete platform",
    customMediaDeleteConfirm:
      "Delete this custom platform? Its saved token will be deleted too.",
    customMediaEditTitle: "Edit custom platform",
    customMediaAddTitle: "Add custom platform",
    customMediaCancel: "Cancel",
    customMediaSaving: "Saving…",
    customMediaSave: "Save platform",
    customMediaSaveFailed: "Could not save the custom platform. Check the settings and try again.",
    customMediaDeleteFailed: "Could not delete the custom platform. Try again.",
    freePlan: "Free",
  ...
  editor: {
    ...
    deleteSelectedConfirm: "Delete the selected {count} items? Documents will move to trash; folder contents will move up one level.",
    ...
    noOpenDocument: "No document is open. Choose one from the list or create a new one.",
    ...
    sharedSignupPrompt: "Create a Koinote account to start writing and manage your own documents.",
    sharedSignup: "Create an account",
    exportLabel: "Export",
    ...
    mediaExportHint: "Optimized for WeChat, Zhihu, and X",
    ...
    mediaX: "X",
    mediaXHint: "Publish an X Article with images through the official API",
    mediaCopy: "Copy to clipboard",
    mediaCopied: "Copied — go paste it",
    mediaWorking: "Working…",
    mediaPublished: "Published successfully",
    mediaPublishFailed: "Publishing failed. Check the platform settings and try again.",
    mediaCustomHint: "Publish using the API format you configured",
    mediaCustomSync: "Publish to this platform",
    mediaRichTextNote:
      "Code highlighting, captions, and formulas become pasteable rich text. The destination may still sanitize some styles.",
    mediaMarkdownNote:
      "Copies complete Markdown with the article title, ready to paste into any Markdown-compatible platform or system.",
    ...
    wechatDraftPushHint:
      "Choose a default cover, an article image, or an AI-generated cover before saving the current article as a WeChat draft. It will not be published. Each successful sync costs 20 credits; an AI cover costs an additional 20 credits.",
    ...
    zhihuAccountTitle: "Zhihu publishing",
    zhihuAccountHint:
      "Bind Zhihu OpenAPI credentials. Articles are published directly after your confirmation, not saved as Zhihu drafts.",
    zhihuAccountLoading: "Loading Zhihu connection…",
    zhihuAccountLoadFailed:
      "Could not load the Zhihu connection. Please try again.",
    zhihuAccountRetry: "Retry",
    zhihuAccountNotBound: "No Zhihu account is bound yet.",
    zhihuAccountBind: "Bind Zhihu",
    zhihuAccountSave: "Save connection",
    zhihuAccountEdit: "Update connection",
    zhihuAccountUnbind: "Unbind",
    zhihuAccountUnbindConfirm: "Unbind this Zhihu account?",
    zhihuAccountBindFailed:
      "Could not bind Zhihu. Check the credentials and try again.",
    zhihuAccountSaveFailed:
      "Could not save the Zhihu settings. Please try again.",
    zhihuAccountUnbindFailed: "Could not unbind Zhihu. Please try again.",
    zhihuAccountCancel: "Cancel",
    zhihuAppKey: "Zhihu App Key",
    zhihuAppKeyPlaceholder: "The user token from your Zhihu profile URL",
    zhihuAppSecret: "Zhihu App Secret",
    zhihuAppSecretPlaceholder:
      "Enter the full App Secret generated by Zhihu (it will not be shown again)",
    zhihuAppSecretUpdatePlaceholder:
      "Leave blank to keep the current App Secret",
    zhihuOpenAPIHint: "Open Zhihu Playground to request credentials",
    zhihuPublish: "Publish to Zhihu",
    zhihuPublishing: "Publishing to Zhihu…",
    zhihuPublished: "Published to Zhihu",
    zhihuPublishConfirm:
      "This article will be published directly to Zhihu. Continue?",
    zhihuPublishHint:
      "After confirmation, the article is published directly and can be opened on Zhihu. OpenAPI direct publishing does not support images; use the assisted web flow below instead.",
    zhihuPublishFailed:
      "Could not publish the Zhihu article. Please try again.",
    zhihuImagesUnsupported:
      "Zhihu publishing currently does not support articles containing <img> images. Remove them or publish elsewhere.",
    zhihuAssistPublish: "Copy and open Zhihu",
    zhihuAssistPublishing: "Preparing and opening Zhihu…",
    ...
    xOAuth2NotBound: "Not connected",
    xOAuth2BindFailed: "Could not connect X. Please try again.",
    xOAuth2Unbind: "Disconnect",
    xOAuth2UnbindConfirm: "Disconnect this X OAuth 2.0 account?",
    xOAuth2UnbindFailed: "Could not disconnect X. Please try again.",
    xApiKey: "API Key",
    xApiKeyPlaceholder: "Your X API Key",
    xApiSecret: "API Secret",
    xApiSecretPlaceholder: "Your X API Secret",
    xAccessToken: "Access Token",
    xAccessTokenPlaceholder: "Your X Access Token",
    xAccessTokenSecret: "Access Token Secret",
    xAccessTokenSecretPlaceholder: "Your X Access Token Secret",
    xCredentialUpdatePlaceholder: "Leave blank to keep the saved credential",
    ...
    tabsCloseFailed: "Kept {count} tabs because they could not be saved.",
    undoCloseTabs: "Undo",
    noOpenTabs: "Open a note from the document list",
    dismissTabsNotice: "Dismiss tab notification",
    ...
    renameDocumentFailed: "Could not save the new name. Please retry.",
    ...
    toolbar: {
      ...
      tableClearRow: "Clear current row",
      tableClearColumn: "Clear current column",
      tableClearSelection: "Clear selected cells",
      tableSelectRow: "Select current row",
      tableSelectColumn: "Select current column",
      tableDeleteRow: "Delete current row",
      tableDeleteColumn: "Delete current column",
      tableDelete: "Delete table",
      tableHeaderRow: "Set header row",
      tableAlignLeft: "Align current column left",
      tableAlignCenter: "Center current column",
      tableAlignRight: "Align current column right",
      blockquote: "Quote",
...
`,
  ...
  desktopAuth: {
    ...
    timeout: "Authorization timed out. Return to the app and sign in again.",
  },
  desktopLocalMode: {
    badge: "Local mode",
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            "Export to Markdown, HTML, PDF, DOCX, and formats adapted for WeChat, Zhihu, and X",
  ...
  errors: {
    ...
    invalid_custom_media_name: "The platform name is required and cannot exceed 80 characters",
    invalid_custom_media_endpoint: "The API endpoint must be a public HTTPS URL without query parameters",
    invalid_custom_media_token: "The Bearer token is invalid or too large. Check it and try again",
    custom_media_platform_name_exists: "A custom platform with this name already exists",
    custom_media_platform_limit_reached: "You can create up to 20 custom platforms",
    custom_media_platform_disabled: "This custom platform is disabled",
    custom_media_publish_failed: "The custom platform could not receive the article",
    custom_media_credential_unavailable: "The custom platform token is unavailable. Configure it again",
    custom_media_article_invalid: "The article content is invalid or too large",
    media_platform_disabled: "This publishing platform is disabled in your settings",
    ...
    zhihu_app_key_already_bound:
      "This Zhihu App Key is already bound to another Koinote account",
    ...
    zhihu_publish_failed:
      "Zhihu rejected the article. Check the content and try again",
    zhihu_images_unsupported:
      "Zhihu publishing currently does not support articles containing images. Remove them or publish elsewhere.",
    x_partial_publish:
    ...
    too_many_items: "Select no more than 1,000 items at a time",
    name_too_long: "Folder name is too long",
    invalid_move: "Cannot move that folder here",
    document_revision_conflict: "This document changed elsewhere. Refresh and try again",
