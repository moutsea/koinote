...
export const fr: Messages = {
  ...
  pricing: {
    ...
    lifetimeFeatures: [
      ...
      "Six modèles avancés pour l’écriture, le produit, la recherche et la technique",
  ...
  editor: {
    ...
    exportPrintHint:
      "Texte sélectionnable et recherchable — enregistrez-le en PDF dans la boîte de dialogue système",
