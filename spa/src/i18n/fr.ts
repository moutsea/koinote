...
export const fr: Messages = {
  ...
  agentWorkspace: {
    title: "Synchronisation cloud Skills/Agent",
    repositoryHubTitle: "Hub Skills/Agent",
    repositoryHubDescription: "Gérez vos dépôts de Skills, de prompts système et de configurations Agent depuis un espace dédié, puis ouvrez chaque dépôt pour en gérer le contenu.",
    settingsTitle: "Paramètres Skills/Agent",
    settingsDescription: "Activez la synchronisation cloud et gérez les jetons dédiés utilisés par vos Agents pour accéder à vos dépôts.",
    repositoriesTab: "Dépôts",
    settingsTab: "Paramètres",
    newRepository: "Nouveau dépôt",
    searchRepositories: "Rechercher des dépôts",
    searchRepositoriesPlaceholder: "Rechercher un dépôt…",
    repositoryCount: "{count} dépôts",
    noSearchResults: "Aucun dépôt ne correspond à votre recherche.",
    workspaceAbout: "Votre espace",
    privateWorkspaceDescription: "Les dépôts privés de Skills et de configuration Agent ne sont accessibles qu’à vous et aux Agents autorisés.",
    openSettings: "Ouvrir les paramètres de synchronisation",
    description: "Synchronisez vos Skills, prompts système et réglages portables avec Koinote pour les retrouver sur un autre appareil. Vérifiez les données sensibles avant l’envoi.",
    membersOnly: "La synchronisation cloud Skills/Agent est réservée aux membres à vie.",
    tokenTitle: "Étape 2 : créer un token d’accès",
    tokenSettingsTitle: "Jetons d’accès Agent",
    tokenDescription: "Créez un identifiant Agent dédié, compatible avec l’API REST et MCP. Vous pourrez le révoquer ou le modifier à tout moment.",
    apiTitle: "Configuration de l’API REST",
    apiDescription: "Utilisez le même token Agent pour lire ou synchroniser les dépôts Skills/Agent via HTTP.",
    apiExample: "Exemple d’API REST",
    mcpTitle: "Configuration MCP",
    mcpDescription: "Utilisez le même token Agent pour connecter les agents compatibles via MCP HTTP Streamable.",
    enableStep: "Étape 1 : activer la synchronisation cloud Skills/Agent",
    enable: "Activer la synchronisation cloud",
    enabled: "Activée",
    enableFailed: "Impossible d’activer la synchronisation. Réessayez.",
    repositoriesTitle: "Étape 3 : gérer les dépôts Skills/Agent",
    repositoriesDescription: "Chaque dépôt conserve un ensemble de Skills, de prompts système et de réglages Agent. Les agents peuvent le lire via API ou MCP.",
    noRepositories: "Aucun dépôt. Créez votre premier dépôt, puis importez ses réglages Agent.",
    createFirst: "Créer votre premier dépôt",
    createRepository: "Créer le dépôt",
    createRepositoryTitle: "Créer un nouveau dépôt",
    createRepositoryDescription: "Créez un espace privé pour un ensemble de Skills, de prompts système et de réglages Agent.",
    createRepositoryNameHint: "Choisissez un nom clair pour reconnaître facilement cette configuration plus tard.",
    createRepositoryVisibility: "Dépôt privé",
    createRepositoryVisibilityDescription: "Seuls vous et les Agents autorisés avec votre token Agent peuvent accéder à ce dépôt.",
    repositoryName: "Nom du dépôt",
    repositoryDescription: "Note du dépôt",
    repositoryNamePlaceholder: "Par exemple : Agent rédaction",
    repositoryDescriptionPlaceholder: "Facultatif, pour distinguer les configurations",
    createFailed: "Impossible de créer le dépôt. Vérifiez le nom puis réessayez.",
    selectRepository: "Choisir un dépôt",
    editRepository: "Modifier le dépôt",
    saveRepository: "Enregistrer les informations",
    repositorySettings: "Paramètres du dépôt",
    repositorySettingsSaveFailed: "Impossible d’enregistrer les paramètres du dépôt. Réessayez.",
    deleteRepository: "Supprimer le dépôt",
    deleteRepositoryConfirm: "Tous les fichiers de ce dépôt seront supprimés définitivement. Continuer ?",
    repositorySaved: "Informations du dépôt enregistrées.",
    repositoryDeleted: "Dépôt supprimé.",
    repositoryLoadFailed: "Impossible de charger les dépôts. Réessayez.",
    localMode: "Le mode local ne se connecte jamais au cloud ; cet espace n’est pas disponible.",
    loading: "Chargement de l’espace…",
    loadFailed: "Impossible de charger l’espace. Réessayez.",
    fileCount: "{count} fichiers",
    revision: "Révision",
    empty: "Aucun paramètre hébergé",
    chooseFiles: "Choisir les fichiers de paramètres Agent",
    importButton: "Importer les paramètres Agent",
    selected: "{count} fichiers sélectionnés ; l’enregistrement remplace l’espace actuel.",
    limits: "Les imports web remplacent l’espace hébergé : 200 fichiers maximum et 5 MiB par fichier, sans limite fixe de taille totale. Pour une synchronisation Agent incrémentale, utilisez PATCH ou upsert/delete via MCP. Masquez d’abord les clés API, tokens, mots de passe et clés privées.",
    upload: "Envoyer et synchroniser",
    saved: "Les paramètres hébergés ont été mis à jour.",
    saveFailed: "Impossible d’enregistrer les paramètres. Vérifiez les fichiers puis réessayez.",
    copyPrompt: "Copier pour l’agent IA",
    copied: "Copié",
    promptHint: "La copie inclut le token Agent actuel dans le prompt. Traitez tout le contenu comme sensible ; collez-le uniquement dans un agent IA de confiance et ne le publiez ni ne le commitez jamais.",
    promptFailed: "Impossible de générer l’identifiant de synchronisation Agent. Réessayez.",
    backToRepositories: "Retour aux dépôts",
    filesTitle: "Fichiers du dépôt",
    privateBadge: "Privé",
    kindBadge: "Skills / Agent",
    overviewTitle: "Vue d’ensemble du dépôt",
    updatedLabel: "Dernière mise à jour",
    refresh: "Actualiser",
    importTitle: "Importer des fichiers de configuration",
    importDescription: "Choisissez des fichiers ou déposez-les ici. L’import remplace automatiquement le contenu actuel du dépôt.",
    dropFiles: "Déposez les fichiers ici ou cliquez pour les choisir",
    securityTitle: "Rappel de sécurité",
    securityDescription: "Masquez les clés API, tokens, mots de passe, cookies, clés privées et autres identifiants avant l’envoi. Koinote n’exécute jamais les scripts du dépôt et n’installe aucune dépendance.",
    hashLabel: "SHA-256",
    overviewTab: "Vue d’ensemble",
    filesTab: "Fichiers",
    aboutTitle: "À propos",
    repositoryId: "ID du dépôt",
    syncTitle: "Synchroniser avec votre Agent",
    syncDescription: "Utilisez le prompt généré pour permettre à un Agent de confiance de lire ou modifier ce dépôt via l’API REST ou MCP.",
    uploadFiles: "Importer des fichiers",
    importFolder: "Importer un dossier",
    readmeDescription: "Connexion, import, synchronisation et sécurité",
    readmeImportHint: "L’import d’un dossier remplace les fichiers hébergés. README.md est conservé sauf si le dossier contient son propre README.md.",
    readmeMissing: "Ce dépôt n’a pas de README.md. Importez un dossier pour ajouter vos Skills, prompts système et réglages Agent.",
    readmeLoadFailed: "Impossible de charger README.md. Vous pouvez tout de même importer un dossier ci-dessous.",
    emptyDescription: "Importez des Skills, des prompts système ou des réglages Agent pour commencer à utiliser ce dépôt.",
  },
  llmChannels: {
  ...
  mcp: {
    ...
    agentRead: "Agent API/MCP en lecture seule",
    agentWrite: "Agent API/MCP en lecture-écriture",
    expiry: "Expiration",
    days: "{n} jours",
  ...
  editor: {
    ...
    mediaExportHint: "Adapté à WeChat, Zhihu, Juejin et X",
    ...
    wechatCoverPersistenceFailed:
      "La couverture a été générée, mais n’a pas pu être enregistrée pour plus tard.",
    wechatCoverReferenceUpload: "Téléverser une image de référence",
    wechatCoverReferenceRemove: "Supprimer l’image de référence",
    wechatCoverReferenceInvalid:
      "Choisissez une image PNG, JPEG, GIF ou WebP de 5 Mo maximum.",
    wechatCoverReferenceUploadFailed:
      "Impossible de téléverser l’image de référence. Réessayez plus tard",
    wechatTitleLimit:
