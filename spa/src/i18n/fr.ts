...
export const fr: Messages = {
  ...
  wechatGuide: {
    ...
    billingBody:
      "L’association du compte ne consomme aucun credit ; chaque synchronisation de brouillon réussie coûte 20 credits et les échecs ne sont pas facturés. L’association et l’envoi de brouillons sont disponibles pour les membres payants. Une couverture IA réussie coûte 20 credits supplémentaires ; un échec n’est pas facturé. La génération nécessite aussi un abonnement à vie, un solde suffisant et un modèle d’image configuré pour le service.",
  ...
  docsCenter: {
    ...
    quickStartSteps: [
      ...
      },
      {
        ...
        desc: "Créez un lien en lecture seule, exportez en Markdown, HTML, Word ou PDF, ou préparez le contenu pour WeChat, Zhihu et X.",
      },
    ],
    ...
    workflows: [
      ...
      },
      {
        ...
        items: [
          ...
          "Export adapté à WeChat Official Accounts, Zhihu et X",
        ],
      },
      {
  ...
  feishu: {
    ...
    accountHint: "Les documents sont enregistrés dans votre espace Feishu. Les jetons sont chiffrés sur le serveur.",
    openPlatform: "Plateforme ouverte Feishu",
    bind: "Connecter Feishu",
    unbind: "Déconnecter",
    unbindConfirm: "Déconnecter Feishu ? Les documents déjà créés seront conservés.",
    notBound: "Connectez votre compte Feishu dans les paramètres.",
    unavailable: "L’application Feishu n’est pas configurée sur le serveur. Contactez l’administrateur.",
    connected: "Compte Feishu connecté.",
    loading: "Chargement du compte Feishu…",
    retry: "Réessayer",
    failed: "Échec de l’opération Feishu. Vérifiez l’autorisation, les droits du document ou la connexion.",
    sync: "Synchroniser vers Feishu",
    syncing: "Synchronisation vers Feishu…",
    syncHint: "Crée un document la première fois, puis met à jour le même document. Chaque synchronisation remplace son titre et son contenu par ceux de Koinote, y compris les modifications faites dans Feishu.",
    formats: "Prend en charge le Markdown courant, les tableaux et les images. Les formules, modules et thèmes peuvent conserver leur source ou une mise en forme simplifiée.",
    created: "Document Feishu créé.",
    updated: "Document Feishu mis à jour.",
    open: "Ouvrir le document Feishu",
    close: "Fermer",
    saveFailed: "Terminez l’enregistrement et la synchronisation du document et des images avant de réessayer.",
    tokenInvalid: "L’autorisation Feishu a expiré. Reconnectez votre compte.",
    busy: "Une autre opération Feishu est en cours. Réessayez dans un instant.",
    serverBusy: "Le service Feishu est momentanément occupé. Réessayez dans un instant.",
    contentLimit: "Limite : 5 000 blocs, 20 images et 1 000 blocs par structure imbriquée.",
    imageFailed: "Une image est illisible ou son format n’est pas pris en charge. Vérifiez les images.",
    permissionDenied: "Feishu refuse l’accès. Vérifiez les autorisations de l’application et les droits de modification.",
  },
  settingsPage: {
    media: "Publication",
    mediaDescription: "Gérez les comptes connectés et les paramètres de publication pour WeChat, Zhihu et X.",
    title: "Paramètres",
    subtitle:
    ...
    mediaPlatformsTitle: "Activation des plateformes",
    mediaPlatformsDescription:
      "Désactivez une plateforme pour la retirer des options de publication. Si toutes sont désactivées, l’entrée de publication disparaît du menu d’export.",
    mediaSettingsLoading: "Chargement des réglages de publication…",
    mediaSettingsLoadFailed: "Impossible de charger les réglages de publication.",
    mediaSettingsSaveFailed: "Impossible d’enregistrer l’activation de la plateforme.",
    mediaEnabled: "Activée",
    mediaDisabled: "Désactivée",
    customMediaTitle: "Plateformes API personnalisées",
    customMediaDescription:
      "Configurez une API HTTPS pour envoyer les articles vers votre système ou une autre plateforme avec un format stable.",
    customMediaAdd: "Ajouter une plateforme",
    customMediaEmpty: "Aucune plateforme personnalisée.",
    customMediaFormatTitle: "Format de la requête",
    customMediaFormatDescription:
      "Le endpoint reçoit un POST JSON. Toute réponse 2xx est considérée comme une réussite ; un champ url est facultatif. Le jeton est envoyé comme Authorization: Bearer.",
    customMediaName: "Nom de la plateforme",
    customMediaEndpoint: "Adresse API",
    customMediaEndpointHint:
      "Utilisez une URL HTTPS publique. Votre système définit le chemin et traite la requête.",
    customMediaAuthToken: "Jeton Bearer",
    customMediaAuthTokenHint:
      "Facultatif. Le jeton est chiffré et jamais affiché ; laissez-le vide en modification pour le conserver.",
    customMediaClearToken: "Supprimer le jeton enregistré",
    customMediaEdit: "Modifier la plateforme",
    customMediaDelete: "Supprimer la plateforme",
    customMediaDeleteConfirm:
      "Supprimer cette plateforme personnalisée ? Son jeton enregistré sera aussi supprimé.",
    customMediaEditTitle: "Modifier la plateforme personnalisée",
    customMediaAddTitle: "Ajouter une plateforme personnalisée",
    customMediaCancel: "Annuler",
    customMediaSaving: "Enregistrement…",
    customMediaSave: "Enregistrer la plateforme",
    customMediaSaveFailed: "Impossible d’enregistrer la plateforme personnalisée.",
    customMediaDeleteFailed: "Impossible de supprimer la plateforme personnalisée.",
    freePlan: "Gratuit",
  ...
  editor: {
    ...
    deleteSelectedConfirm: "Supprimer les {count} éléments sélectionnés ? Les documents seront mis à la corbeille et le contenu des dossiers remontera d’un niveau.",
    ...
    noOpenDocument: "Aucun document ouvert. Choisissez-en un dans la liste ou créez-en un.",
    ...
    codeBlockCopyFailed: "Échec de la copie",
    share: "Partager",
    ...
    sharedSignupPrompt: "Créez un compte Koinote pour commencer à écrire et gérer vos propres documents.",
    sharedSignup: "Créer un compte",
    ...
    mediaExportHint: "Adapté à WeChat, Zhihu et X",
    ...
    mediaX: "X",
    mediaXHint: "Publier un Article X avec ses images via l’API officielle",
    mediaCopy: "Copier",
    mediaCopied: "Copié — vous pouvez coller",
    mediaWorking: "Traitement…",
    mediaPublished: "Publication réussie",
    mediaPublishFailed: "Échec de la publication. Vérifiez la configuration et réessayez.",
    mediaCustomHint: "Publier selon le format API configuré",
    mediaCustomSync: "Publier vers cette plateforme",
    mediaRichTextNote:
      "La coloration, les légendes et les formules deviennent du texte enrichi. La plateforme peut nettoyer certains styles.",
    mediaMarkdownNote:
      "Copie le Markdown complet avec le titre, prêt à être collé dans toute plateforme ou tout système compatible Markdown.",
    ...
    wechatDraftPushHint:
      "Choisissez une couverture par défaut, une image de l’article ou une couverture générée par IA avant d’enregistrer l’article actuel comme brouillon WeChat. Il ne sera pas publié. Chaque synchronisation réussie coûte 20 credits ; une couverture IA coûte 20 credits supplémentaires.",
    ...
    xAccountEdit: "Modifier la connexion X",
    xAccountUnbind: "Dissocier",
    xAccountUnbindConfirm: "Dissocier ce compte X ?",
    xAccountBindFailed: "Impossible d’associer X. Vérifiez les identifiants.",
    xAccountSaveFailed: "Impossible d’enregistrer la connexion X.",
    ...
    xOAuth2NotBound: "Non connecté",
    xOAuth2BindFailed: "Connexion à X impossible. Réessayez.",
    xOAuth2Unbind: "Déconnecter",
    xOAuth2UnbindConfirm: "Déconnecter ce compte X OAuth 2.0 ?",
    xOAuth2UnbindFailed: "Déconnexion de X impossible. Réessayez.",
    xApiKey: "API Key",
    xApiKeyPlaceholder: "Votre API Key X",
    xApiSecret: "API Secret",
    xApiSecretPlaceholder: "Votre API Secret X",
    ...
    closingTabs: "Enregistrement…",
    tabsClosed: "{count} onglets fermés",
    tabsCloseFailed: "{count} onglets conservés : enregistrement impossible.",
    undoCloseTabs: "Annuler",
    noOpenTabs: "Ouvrez une note depuis la liste des documents",
    dismissTabsNotice: "Fermer la notification des onglets",
    tabActions: "Actions sur les onglets",
    ...
    renameDocumentFailed: "Impossible d’enregistrer le nouveau nom. Réessayez.",
    ...
    toolbar: {
      ...
      tableClearRow: "Vider la ligne actuelle",
      tableClearColumn: "Vider la colonne actuelle",
      tableClearSelection: "Vider les cellules sélectionnées",
      tableSelectRow: "Sélectionner la ligne actuelle",
      tableSelectColumn: "Sélectionner la colonne actuelle",
      tableDeleteRow: "Supprimer la ligne actuelle",
      tableDeleteColumn: "Supprimer la colonne actuelle",
      tableDelete: "Supprimer le tableau",
      tableHeaderRow: "Définir la ligne d’en-tête",
      tableAlignLeft: "Aligner la colonne à gauche",
      tableAlignCenter: "Centrer la colonne",
      tableAlignRight: "Aligner la colonne à droite",
      blockquote: "Citation",
...
`,
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            "Export en Markdown, HTML, PDF, DOCX et formats adaptés à WeChat, Zhihu et X",
  ...
  errors: {
    ...
    invalid_custom_media_name: "Le nom de la plateforme est requis et ne peut pas dépasser 80 caractères",
    invalid_custom_media_endpoint: "L’endpoint API doit être une URL HTTPS publique sans paramètres de requête",
    invalid_custom_media_token: "Le jeton Bearer est invalide ou trop volumineux. Vérifiez-le puis réessayez",
    custom_media_platform_name_exists: "Une plateforme personnalisée portant ce nom existe déjà",
    custom_media_platform_limit_reached: "Vous pouvez créer jusqu’à 20 plateformes personnalisées",
    custom_media_platform_disabled: "Cette plateforme personnalisée est désactivée",
    custom_media_publish_failed: "La plateforme personnalisée n’a pas pu recevoir l’article",
    custom_media_credential_unavailable: "Le jeton de la plateforme personnalisée est indisponible. Configurez-le à nouveau",
    custom_media_article_invalid: "Le contenu de l’article est invalide ou trop volumineux",
    media_platform_disabled: "Cette plateforme de publication est désactivée dans vos réglages",
    ...
    x_image_upload_failed:
      "X n’a pas pu téléverser l’image de l’article. Vérifiez l’image puis réessayez",
    x_provider_unavailable:
      "X est temporairement indisponible. Réessayez plus tard",
    x_publish_failed:
      "X a refusé l’article. Vérifiez son contenu puis réessayez",
    ...
    too_many_items: "Sélectionnez au maximum 1 000 éléments à la fois",
    name_too_long: "Nom de dossier trop long",
    invalid_move: "Impossible de déplacer ce dossier ici",
    document_revision_conflict:
      "Ce document a été modifié ailleurs. Actualisez puis réessayez",
