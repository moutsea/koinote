...
export const ja: Messages = {
  ...
  pricing: {
    ...
    lifetimeFeatures: [
      ...
      "将来の AI 機能公開後の会員利用資格（合理的な利用量・提供範囲の制限あり）",
      "無料版のすべての機能",
    ],
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "まだです。関連機能の公開後に会員利用資格が得られますが、公開日、具体的なモデルや機能、無制限の無料推論は保証しません。利用量、費用、地域、提供事業者による制限が適用される場合があります。",
      },
    ],
  },
  mcpGuide: {
