...
export const ja: Messages = {
  ...
  docsCenter: {
    ...
    quickStartSteps: [
      ...
      {
        title: "共有・書き出し・公開",
        desc: "読み取り専用リンクを作るか、Markdown、HTML、Word、PDF、WeChat、知乎、X 向けに書き出します。",
      },
    ],
  ...
  feishu: {
    ...
    accountHint: "文書はあなたの Feishu スペースに保存されます。認証トークンはサーバーで暗号化されます。",
    openPlatform: "Feishu オープンプラットフォーム",
    bind: "Feishu を連携",
    unbind: "連携を解除",
    unbindConfirm: "連携を解除しますか？作成済みの Feishu 文書は残ります。",
    notBound: "設定で Feishu アカウントを連携してください。",
    unavailable: "サーバーに Feishu アプリが設定されていません。管理者にお問い合わせください。",
    connected: "Feishu アカウントを連携しました。",
    loading: "Feishu の連携を読み込み中…",
    retry: "再試行",
    failed: "Feishu の操作に失敗しました。認証、文書の権限、接続を確認してください。",
    sync: "Feishu に同期",
    syncing: "Feishu に同期中…",
    syncHint: "初回は文書を作成し、以降は同じ文書を更新します。同期するたびに Koinote のタイトルと本文で上書きし、Feishu 側の編集も置き換えます。",
    formats: "一般的な Markdown、表、画像に対応。数式、独自モジュール、テーマはソースや簡易書式で残る場合があります。",
    created: "Feishu 文書を作成しました。",
    updated: "Feishu 文書を更新しました。",
    open: "Feishu 文書を開く",
    close: "閉じる",
    saveFailed: "文書と画像の保存・オンライン同期が完了してから再試行してください。",
    tokenInvalid: "Feishu の認証が失効しました。再度連携してください。",
    busy: "別の Feishu 操作が実行中です。しばらくしてから再試行してください。",
    serverBusy: "Feishu サービスが混み合っています。しばらくしてから再試行してください。",
    contentLimit: "同期の上限は 5,000 ブロック、画像 20 枚、入れ子構造ごとに 1,000 ブロックです。",
    imageFailed: "画像を読み込めないか、形式に対応していません。画像を確認してください。",
    permissionDenied: "Feishu にアクセスを拒否されました。アプリと文書の編集権限を確認してください。",
  },
  settingsPage: {
    media: "メディア配信",
    mediaDescription: "WeChat 公式アカウント、知乎、X のアカウント連携と投稿設定を管理します。",
    title: "設定",
    ...
    mediaPlatformsTitle: "配信プラットフォームのオン／オフ",
    mediaPlatformsDescription:
      "オフにしたプラットフォームは文書の配信メニューから消えます。すべてオフにすると配信入口自体が表示されません。",
    mediaSettingsLoading: "配信設定を読み込み中…",
    mediaSettingsLoadFailed: "配信設定を読み込めませんでした。再試行してください。",
    mediaSettingsSaveFailed: "プラットフォーム設定を保存できませんでした。",
    mediaEnabled: "オン",
    mediaDisabled: "オフ",
    customMediaTitle: "カスタム API プラットフォーム",
    customMediaDescription:
      "HTTPS API を設定すると、決められた形式で記事を自分のシステムや別のプラットフォームへ送信できます。",
    customMediaAdd: "プラットフォームを追加",
    customMediaEmpty: "カスタムプラットフォームはありません。",
    customMediaFormatTitle: "リクエスト形式",
    customMediaFormatDescription:
      "エンドポイントは POST JSON を受け取ります。2xx 応答で成功とし、任意の url フィールドを記事リンクとして返せます。トークンは Authorization: Bearer で送信します。",
    customMediaName: "プラットフォーム名",
    customMediaEndpoint: "API エンドポイント",
    customMediaEndpointHint: "公開 HTTPS URL が必要です。パスと処理はあなたのシステムで定義します。",
    customMediaAuthToken: "Bearer トークン",
    customMediaAuthTokenHint:
      "任意。トークンは暗号化保存され、表示されません。編集時に空欄にすると既存のトークンを保持します。",
    customMediaClearToken: "保存済みのトークンを削除",
    customMediaEdit: "プラットフォームを編集",
    customMediaDelete: "プラットフォームを削除",
    customMediaDeleteConfirm:
      "このカスタムプラットフォームを削除しますか？保存済みのトークンも削除されます。",
    customMediaEditTitle: "カスタムプラットフォームを編集",
    customMediaAddTitle: "カスタムプラットフォームを追加",
    customMediaCancel: "キャンセル",
    customMediaSaving: "保存中…",
    customMediaSave: "プラットフォームを保存",
    customMediaSaveFailed: "カスタムプラットフォームを保存できませんでした。",
    customMediaDeleteFailed: "カスタムプラットフォームを削除できませんでした。",
    freePlan: "無料ユーザー",
    lifetimePlan: "永久会員",
    upgrade: "会員にアップグレード",
  ...
  editor: {
    ...
    deleteSelectedConfirm: "選択した {count} 件を削除しますか？ドキュメントはゴミ箱へ移動し、フォルダーの内容は一つ上の階層へ移動します。",
    ...
    noOpenDocument: "開いているドキュメントがありません。リストから選ぶか、新しく作成してください。",
    ...
    sharedSignupPrompt: "Koinote に登録して、文章を書き始め、自分のドキュメントを管理しましょう。",
    sharedSignup: "アカウント登録",
    exportLabel: "エクスポート",
    ...
    mediaExportHint: "WeChat、Zhihu、X に最適化",
    ...
    mediaCopied: "コピーしました",
    mediaWorking: "処理中…",
    mediaPublished: "公開しました",
    mediaPublishFailed: "公開に失敗しました。設定を確認して再試行してください。",
    mediaCustomHint: "設定した API 形式で公開",
    mediaCustomSync: "このプラットフォームへ公開",
    mediaRichTextNote:
      "コード、画像キャプション、数式を貼り付け可能な形式に変換します。投稿先で一部スタイルが削除される場合があります。",
    mediaMarkdownNote:
      "記事タイトルを含む完全な Markdown をコピーし、Markdown 対応のプラットフォームやシステムに貼り付けられます。",
    ...
    closeAllTabs: "すべて閉じる",
    closingTabs: "保存中…",
    tabsClosed: "{count} 個のタブを閉じました",
    tabsCloseFailed: "{count} 個のタブは保存できなかったため残しました。",
    undoCloseTabs: "元に戻す",
    noOpenTabs: "文書一覧からノートを開いてください",
    dismissTabsNotice: "タブの通知を閉じる",
    tabActions: "タブ操作",
    ...
    renameDocumentFailed: "新しい名前を保存できませんでした。もう一度お試しください。",
...
`,
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            "ドキュメントとフォルダの管理",
            "画像のアップロードとホスティング",
            "Markdown、HTML、PDF、DOCX、WeChat・Zhihu・X 向け形式への書き出し",
  ...
  errors: {
    ...
    invalid_custom_media_name: "プラットフォーム名は必須で、80 文字以内にしてください",
    invalid_custom_media_endpoint: "API エンドポイントはクエリなしの公開 HTTPS URL にしてください",
    invalid_custom_media_token: "Bearer トークンが無効か大きすぎます。確認して再試行してください",
    custom_media_platform_name_exists: "同じ名前のカスタムプラットフォームがすでにあります",
    custom_media_platform_limit_reached: "カスタムプラットフォームは最大 20 件まで作成できます",
    custom_media_platform_disabled: "このカスタムプラットフォームは無効です",
    custom_media_publish_failed: "カスタムプラットフォームへの同期に失敗しました",
    custom_media_credential_unavailable: "カスタムプラットフォームのトークンを利用できません。再設定してください",
    custom_media_article_invalid: "記事の内容が無効か大きすぎます",
    media_platform_disabled: "この公開プラットフォームは設定で無効になっています",
    ...
    too_many_items: "一度に選択できる項目は 1,000 件までです",
    name_too_long: "フォルダ名が長すぎます",
    invalid_move: "このフォルダをここへは移動できません",
    document_revision_conflict: "この文書は別の場所で変更されました。更新して再試行してください",
