...
export const ja: Messages = {
  ...
  auth: {
    ...
    emailVerificationRequired: "パスワードを確認しました。続行するにはメール認証を完了してください。",
    verifyEmailTitle: "メールアドレスが未確認です",
    verifyEmailDescription: "下記のアドレスにコードを送信します。確認後、そのままログインします。",
    ...
    invitationBonusHint: "Google、GitHub、メールのどの方法でも有効です。登録後、友達にも 500 MB が追加されます。",
  ...
  membership: {
    ...
    lifetimeBadge: "永久有効",
    activeBadge: "有効",
    description: "一度のアップグレードで、より大きな執筆スペースと今後の AI 機能へのアクセスを獲得できます。",
    ...
    activeDescription: "10 GB のクラウドストレージと今後の AI 機能へのアクセスが含まれます。",
  ...
  invitations: {
    ...
    description: "友達が専用リンクから登録すると、双方のクラウド容量に {reward} が無期限で追加されます。",
    copyLink: "招待リンクをコピー",
    copied: "コピーしました",
    successful: "招待成功",
    earned: "招待で獲得",
  ...
  admin: {
    ...
    loadFailed: "統計を読み込めませんでした。しばらくしてから再試行してください。",
    today: "今日の概要",
...
`,
  ...
  errors: {
    ...
    invalid_invitation_code: "招待コードが無効です。確認してもう一度お試しください",
    ...
    verification_code_expired: "確認コードの有効期限が切れました。再送信してください",
    verification_attempts_exceeded: "入力回数が上限を超えました。新しいコードを送信してください",
    verification_rate_limited: "確認コードのリクエストが多すぎます。後でもう一度お試しください",
    email_send_failed: "確認メールを送信できませんでした。もう一度お試しください",
    email_not_verified: "メールアドレスが確認されていません",
    email_already_verified: "メールアドレスは確認済みです。通常のログインに戻ってください",
