...
export const ja: Messages = {
  ...
  home: {
    ...
    mcp: {
      ...
      description:
        "ブラウザ拡張は不要です。取り消し可能で期限付きの個人トークンを作成すると、Codex、Claude Code、OpenCode などの標準 MCP クライアントが許可範囲内で Koinote 文書を検索・閲覧・編集できます。",
  ...
  mcp: {
    ...
    membersOnly:
      "MCP は有料会員向け機能です。アップグレードすると、期限付きで取り消し可能なトークンを作成できます。",
