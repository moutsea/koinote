...
export interface Messages {
  ...
  agentWorkspace: {
    title: string;
    repositoryHubTitle: string;
    repositoryHubDescription: string;
    ...
    searchRepositoriesPlaceholder: string;
    repositoryCount: string;
    noSearchResults: string;
    workspaceAbout: string;
    privateWorkspaceDescription: string;
    openSettings: string;
    description: string;
    membersOnly: string;
    tokenTitle: string;
    ...
    createRepositoryTitle: string;
    createRepositoryDescription: string;
    createRepositoryNameHint: string;
    createRepositoryVisibility: string;
    createRepositoryVisibilityDescription: string;
    ...
    repositorySettingsSaveFailed: string;
    deleteRepository: string;
    deleteRepositoryConfirm: string;
    ...
    readmeImportHint: string;
    readmeMissing: string;
    readmeLoadFailed: string;
