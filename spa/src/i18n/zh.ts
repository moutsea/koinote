...
export const zh: Messages = {
  ...
  docsCenter: {
    ...
    xTitle: "X 本地浏览器助手",
    xDescription: "学习如何获取 auth_token 和 ct0，并在桌面客户端安全启动本地助手。",
    readGuide: "阅读指南",
    safetyTitle: "迁移建议",
    safetyBody:
  ...
  editor: {
    ...
    xAccountTitle: "X 发布",
    xAccountHint: "通过 X 官方 OAuth 2.0 授权连接账号，把 Koinote 长文和图片直接发布为 X 文章。",
    ...
    xOAuth2Hint: "推荐使用 X 官方授权。只有 X Premium 或 Premium+ 账号可以发布文章；每次成功发布消耗 20 Koinote credits。令牌会加密保存，不会下发到客户端。",
    ...
    xPublishing: "正在发布到 X…",
    xPublished: "已发布到 X",
    xPublishConfirm: "将全文和图片发布为一篇 X 文章？只有 X Premium 或 Premium+ 账号可以发布文章，成功发布会消耗 20 Koinote credits，发布后立即公开。",
    xPublishHint: "只有 X Premium 或 Premium+ 账号可以发布完整的 X 文章。每次成功发布消耗 20 Koinote credits，发布后会立即公开。",
    xPublishOAuth2BillingHint: "发布会通过 X 官方 OAuth 2.0 和 Articles API，Koinote 会在成功发布后扣除 20 credits。",
    xPublishFailed: "发布到 X 失败，请稍后重试",
    xPublishTooLong: "文章拆分后超过 X 串文的 25 条上限，请缩短正文后重试",
    xPublishTooManyImages: "当前单篇 X 发布最多支持 20 张图片，请删减图片后重试",
...
`,
  ...
  errors: {
    ...
    zhihu_images_unsupported: "知乎发布暂不支持包含图片的文章，请移除图片或改用其他平台发布。",
    ...
    x_article_unavailable: "当前 X 账号或开发者应用没有 Articles API 权限，请检查 X Premium 和开发者权限",
    x_article_draft_only: "X 已保存文章草稿，但未能公开发布。请先到 X 文章草稿中检查，避免重复创建",
