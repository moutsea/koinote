...
export const zh: Messages = {
  ...
  pricing: {
    ...
    lifetimeFeatures: [
      ...
      "可配置版本历史与安全快照恢复",
      "未来 AI 功能上线后的会员使用资格（受合理用量与可用范围限制）",
      "包含免费版全部能力",
    ],
    ...
    faqs: [
      ...
      },
      {
        question: "AI 功能现在可用吗？",
        answer:
          "尚未上线。终生会员在相关功能发布后享有会员使用资格，但不承诺发布日期、具体模型或无限免费调用；实际使用可能受合理用量、成本、地区和供应商可用性限制。",
      },
    ],
  },
  mcpGuide: {
  ...
  membership: {
    ...
    lifetimeBadge: "终生有效",
    activeBadge: "已开通",
    description: "一次升级，获得更充裕的创作空间、MCP、版本历史和未来 AI 功能的会员使用资格。",
    oneTimePayment: "一次付费，终生有效",
    currencyLabel: "支付币种",
    currencyHint: "选择后将在 Stripe 收银台以该币种结算。",
    storageBenefit: "10 GB 云存储",
    aiBenefit: "未来 AI 功能上线后的会员使用资格",
    aiComingSoon: "AI 功能将在后续上线",
    purchase: "开通终生会员",
    redirecting: "正在前往安全支付页面…",
    activeTitle: "终生会员已解锁",
    activeDescription: "你的账号已获得固定 10 GB 云存储，以及未来 AI 功能上线后的会员使用资格。",
