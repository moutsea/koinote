...
export const zh: Messages = {
  ...
  agentWorkspace: {
    title: "Skills/Agent 云端同步",
    repositoryHubTitle: "Skills/Agent Hub",
    repositoryHubDescription: "集中管理你的 Skills、系统提示词和 Agent 配置仓库，并从这里进入每个仓库的内容页面。",
    settingsTitle: "Skills/Agent 设置",
    settingsDescription: "启用云端同步，并管理 Agent 访问仓库时使用的专用 Token。",
    repositoriesTab: "仓库",
    settingsTab: "设置",
    newRepository: "新建仓库",
    searchRepositories: "搜索仓库",
    searchRepositoriesPlaceholder: "查找仓库…",
    repositoryCount: "{count} 个仓库",
    noSearchResults: "没有匹配搜索条件的仓库。",
    workspaceAbout: "你的云端空间",
    privateWorkspaceDescription: "Skills 和 Agent 配置仓库默认仅对你和获得授权的 Agent 可见。",
    openSettings: "打开同步设置",
    description: "将 Skills、系统提示词和可迁移设置安全同步到 Koinote，换设备后仍可读取。上传前请确认内容不含敏感数据。",
    membersOnly: "Skills/Agent 云端同步是终生会员权益。",
    tokenTitle: "第二步：创建访问 Token",
    tokenSettingsTitle: "Agent 访问 Token",
    tokenDescription: "为 Agent 创建同时支持 REST API 和 MCP 的专用访问凭证。你可以设置备注和有效期，并随时撤销或调整。",
    apiTitle: "REST API 配置",
    apiDescription: "使用同一个 Agent Token，通过 HTTP API 读取或同步 Skills/Agent 仓库。",
    apiExample: "REST API 示例",
    mcpTitle: "MCP 配置",
    mcpDescription: "使用同一个 Agent Token，通过 Streamable HTTP MCP 连接兼容的 Agent。",
    enableStep: "第一步：启用 Skills/Agent 云端同步",
    enable: "启用云端同步",
    enabled: "已启用",
    enableFailed: "启用失败，请稍后重试。",
    repositoriesTitle: "第三步：管理 Skills/Agent 仓库",
    repositoriesDescription: "每个仓库独立保存一套 Skills、系统提示词和 Agent 设置；Agent 可通过 API 或 MCP 读取。",
    noRepositories: "还没有仓库。创建第一份仓库后，再导入对应的 Agent 配置文件。",
    createFirst: "创建第一份仓库",
    createRepository: "创建仓库",
    createRepositoryTitle: "创建新仓库",
    createRepositoryDescription: "为一套 Skills、系统提示词和 Agent 设置创建独立的私有空间。",
    createRepositoryNameHint: "选择一个清晰的名称，方便之后识别这套配置。",
    createRepositoryVisibility: "私有仓库",
    createRepositoryVisibilityDescription: "只有你和通过 Agent Token 获得授权的 Agent 可以访问这个仓库。",
    repositoryName: "仓库名称",
    repositoryDescription: "仓库备注",
    repositoryNamePlaceholder: "例如：写作 Agent",
    repositoryDescriptionPlaceholder: "可选，用于区分不同配置",
    createFailed: "仓库创建失败，请检查名称后重试。",
    selectRepository: "选择仓库",
    editRepository: "编辑仓库",
    saveRepository: "保存仓库信息",
    repositorySettings: "仓库基础设置",
    repositorySettingsSaveFailed: "仓库设置保存失败，请稍后重试。",
    deleteRepository: "删除仓库",
    deleteRepositoryConfirm: "删除后仓库中的全部文件都会被永久删除，确定继续吗？",
    repositorySaved: "仓库信息已保存。",
    repositoryDeleted: "仓库已删除。",
    repositoryLoadFailed: "仓库列表加载失败，请稍后重试。",
    localMode: "本地模式不会连接云端，无法使用 Agent 设置托管。",
    loading: "正在读取托管内容…",
    loadFailed: "托管内容加载失败，请稍后重试。",
    fileCount: "当前 {count} 个文件",
    revision: "版本",
    empty: "还没有托管内容",
    chooseFiles: "选择 Agent 设置文件",
    importButton: "导入 Agent 配置",
    selected: "已选择 {count} 个文件；保存后会替换当前托管内容。",
    limits: "网页端导入会完整替换当前托管内容：单文件最多 5 MiB，总大小不设固定上限。Agent 增量同步请使用 PATCH 或 MCP 的 upsert/delete。请先脱敏 API Key、Token、密码和私钥。",
    upload: "上传并同步",
    saved: "托管内容已更新。",
    saveFailed: "托管内容保存失败，请检查文件并重试。",
    copyPrompt: "复制给 AI Agent",
    copied: "已复制",
    promptHint: "复制时会把当前 Agent Token 放入提示词。整段内容包含敏感凭证，请只粘贴给你信任的 AI Agent，不要公开或提交到代码仓库。",
    promptFailed: "生成 Agent 同步凭证失败，请稍后重试。",
    ...
    refresh: "刷新",
    importTitle: "导入配置文件",
    importDescription: "选择文件或直接拖放到这里，导入后会自动替换当前仓库内容。",
    dropFiles: "拖放文件到这里，或点击选择文件",
    securityTitle: "安全提醒",
    securityDescription: "上传前请检查并脱敏 API Key、Token、密码、Cookie、私钥和其他凭证。Koinote 不会执行仓库中的脚本或安装依赖。",
    hashLabel: "SHA-256",
    overviewTab: "概览",
    filesTab: "文件",
    aboutTitle: "关于",
    repositoryId: "仓库 ID",
    syncTitle: "让你的 Agent 连接",
    syncDescription: "复制生成的提示词，让你信任的 Agent 通过 REST API 或 MCP 读取或更新这个仓库。",
    uploadFiles: "导入文件",
    importFolder: "导入文件夹",
    readmeDescription: "了解如何连接、上传、同步以及保护敏感信息",
    readmeImportHint: "导入文件夹会替换托管文件；除非文件夹中包含自己的 README.md，否则系统会保留当前指南。",
    readmeMissing: "这个仓库还没有 README.md。导入文件夹后即可添加 Skills、系统提示词和 Agent 设置。",
    readmeLoadFailed: "README.md 加载失败，你仍然可以在下方导入文件夹。",
    emptyDescription: "导入 Skills、系统提示词或 Agent 设置，开始使用这个仓库。",
  },
  llmChannels: {
    title: "自有 LLM 渠道",
    description:
  ...
  mcp: {
    ...
    readWrite: "读写",
    publishOnly: "仅发布",
    agentRead: "Agent API/MCP 只读",
    agentWrite: "Agent API/MCP 读写",
    expiry: "有效期",
    days: "{n} 天",
    neverExpires: "永久",
    editExpiry: "编辑有效期",
  ...
  editor: {
    ...
    mediaExport: "导出到自媒体",
    mediaExportHint: "适配微信公众号、知乎、掘金与 X",
    mediaTitle: "导出到自媒体",
    ...
    wechatCoverPersistenceFailed: "封面已生成，但保存失败；当前仍可继续发布。",
    wechatCoverReferenceUpload: "上传参考图",
    wechatCoverReferenceRemove: "移除参考图",
    wechatCoverReferenceInvalid: "请选择 5 MB 以内的 PNG、JPEG、GIF 或 WebP 图片。",
    wechatCoverReferenceUploadFailed: "参考图上传失败，请稍后重试",
