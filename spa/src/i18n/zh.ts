...
export const zh: Messages = {
  ...
  home: {
    ...
    mcp: {
      ...
      description:
        "无需浏览器插件。创建一枚可撤销、可过期的个人令牌，Codex、Claude Code、OpenCode 等标准 MCP 客户端就能在你的授权范围内查找、读取和编辑 Koinote 文档。",
  ...
  mcp: {
    ...
    membersOnly: "MCP 是付费会员权益。升级后可创建可撤销、可过期的访问令牌。",
    upgrade: "升级终生会员",
    tokenName: "令牌名称",
    scope: "权限",
    readOnly: "只读",
  ...
  editor: {
    ...
    wechatSubtitle: "样式会内联到每个元素，粘贴后排版不丢。公式转成图片上传。",
